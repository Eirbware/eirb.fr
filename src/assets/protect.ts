...
function login(redirect = window.location.origin + window.location.pathname) {
    window.location.href = `${window.location.origin}/protect/login.php?redirect=${redirect}`;
}
...
function logout(redirect = window.location.origin) {
    window.location.href = `/protect/logout.php?redirect=${redirect}`;
}
 ...
 * default to '/'.
 */
function redirect(redirectId: string) {
    window.location.href = `/protect/link.php?name=${redirectId}`;
}

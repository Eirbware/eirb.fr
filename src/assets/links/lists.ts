...
const lists: LinkGroup = {
  ...
  links: [
    ...
    {
      name: "Millionn'eirb",
      description: "Liste BDE 2026/2027 perdante",
      url: 'https://millionn.eirb.fr/',
      icon: 'lists/x128/millionneirb.png',
    },
    {
      name: "Minist'eirb",
      description: 'Liste BDE 2025/2026 gagnante',
      url: 'https://minist.eirb.fr/',
      icon: 'lists/x128/ministeirb.png',
    },
    {
      name: "Gladiat'eirb",
      description: 'Liste BDE 2025/2026 perdante',
      url: 'https://gladiat.eirb.fr/',
      icon: 'lists/x128/gladiateirb.png',
    },
    {
      name: "Hollywood'eirb",
